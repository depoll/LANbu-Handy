...
class TestModelPreviewEndpoint:
    ...
    def test_get_model_preview_invalid_extension(self, client):
        ...
        # Create a temp file with invalid extension but place it in model service temp dir
    ...
    def test_get_model_preview_success_stl(self, mock_model_service, client, temp_model_file):
