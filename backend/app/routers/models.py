"""
LANbu Handy - Models Router

FastAPI router for model-related endpoints including model submission,
preview, thumbnails, and filament requirement analysis.
"""
...
# Service instances - these will be injected from main.py
model_service: Optional[ModelService] = None
thumbnail_service: Optional[ThumbnailService] = None


def set_dependencies(model_svc: ModelService, thumbnail_svc: ThumbnailService):
    """
    Set service dependencies for the models router.
    
    Args:
        model_svc: ModelService instance
        thumbnail_svc: ThumbnailService instance
    """
    global model_service, thumbnail_service
    model_service = model_svc
    thumbnail_service = thumbnail_svc
