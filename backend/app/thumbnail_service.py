...
class ThumbnailService:
    ...
    def _generate_with_cli(
        ...
        Uses the --export-png functionality with virtual display support.
        """
        ...
        try:
            ...
            if result.success:
                ...
                if png_files:
                    ...
                    logger.warning("CLI export succeeded but no PNG files found")
                    return CLIResult(
                        exit_code=1,
                        stdout="",
                        stderr="No PNG files generated by CLI",
                        success=False,
                    )
            else:
            ...
            return CLIResult(
                exit_code=1,
                stdout="",
                stderr=f"Exception during CLI thumbnail generation: {e}",
                success=False,
            )
        finally:
