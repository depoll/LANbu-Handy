...
describe('ProgressBar Component', () => {
  ...
  it('clamps value between 0 and 100', () => {
    ...
    const progressFill1 = container1.querySelector('.progress-bar-fill') as HTMLElement;
    expect(progressFill1.style.width).toBe('100%');

    const { container: container2 } = render(<ProgressBar value={-10} />);
    const progressFill2 = container2.querySelector('.progress-bar-fill') as HTMLElement;
